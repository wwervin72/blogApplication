define(['markdownService','marked'], function (markdownService,marked) {
	var dependency = [];
	var editorModel = angular.module('ervin.editor', dependency);
	editorModel.controller('ervin.editor.ctrl', ['$rootScope','$scope','$cookies','$state','http','message-service', function($rootScope,$scope,$cookies,$state,http,message){
		$(function () {
            // 初始化编辑器
